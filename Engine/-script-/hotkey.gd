...
@onready var keysets = $Flow.get_children()
@onready var ebc = [$v/A.get_theme_stylebox("normal"),$v/B.get_theme_stylebox("normal"),$v/C.get_theme_stylebox("normal"),$v/D.get_theme_stylebox("normal"),$v/E.get_theme_stylebox("normal")]
